...
const CartWidget = () => {
    return(
      <button type="button" className="btn btn-primary d-flex">
        <span className="top-0 start-100 translate-middle badge rounded-pill bg-danger">1</span>
        <svg className="carrito" width="50" height="40" fill="currentColor" class="bi bi-cart-plus-fill" viewBox="2 0 16 16">
